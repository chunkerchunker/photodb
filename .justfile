...
@cluster collection_id:
  uv run python scripts/bootstrap_clusters.py --collection-id {{collection_id}}

@group-clusters collection_id:
  uv run photodb-maintenance auto-associate --collection-id {{collection_id}}

@reset-clusters collection_id:
  uv run python scripts/reset_clustering.py --collection-id {{collection_id}}
