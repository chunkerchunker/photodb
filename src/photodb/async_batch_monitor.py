...
class AsyncBatchMonitor:
    ...
    async def submit_and_monitor_batches(self, enrich_stage, photo_batches: List[List]) -> Dict[str, Any]:
    ...
    async def _monitor_batches_concurrently(self, enrich_stage, batch_ids: List[str]) -> Dict[str, Any]:
