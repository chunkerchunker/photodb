				...
				return (
					<div
						...
						className={cn(
							...
							isHovered
								? "border-blue-500 shadow-lg shadow-blue-500/50 z-20"
								: "border-red-500",
						)}
						style={{
							left: `${left}px`,
					...
					>
						<div
							className={cn(
								...
								labelAbove
									? "top-[-20px] rounded-bl-none"
									: "bottom-[-20px] rounded-tl-none",
							)}
						>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					<div className="space-y-6">
									...
									<CardContent>
										<div className="space-y-3 text-sm">
											...
											<div>
												...
												<code className="text-xs">{photo.id}</code>
											</div>
											<div>
						...
						{photo.face_count && photo.face_count > 0 && (
							<Card>
								<Collapsible
									open={sectionStates.faces}
									onOpenChange={(open) => updateSectionState("faces", open)}
								>
									<CollapsibleTrigger asChild>
										<CardHeader className="cursor-pointer hover:bg-gray-50">
											<CardTitle className="flex items-center justify-between">
										...
										<CardContent className="space-y-4">
											...
											<div className="flex items-center space-x-2">
												<Checkbox
													name="show-faces"
													checked={showFaces}
													onCheckedChange={updateFaceState}
												/>
												<label
													htmlFor="show-faces"
						...
						{(photo.description || photo.emotional_tone || photo.objects) && (
							<Card>
								<Collapsible
									...
									onOpenChange={(open) =>
										updateSectionState("aiAnalysis", open)
									}
								>
									<CollapsibleTrigger asChild>
										<CardHeader className="cursor-pointer hover:bg-gray-50">
